...
const focusSignals = [
  {
    ...
    text: "The Conference setting creates distance from competing demands so participants can stay with consequential legal questions longer.",
  },
  {
    number: "02",
...
const interviews = [
  {
    ...
    description:
      "A reflection on how the Conference setting influences the quality, pace, and seriousness of the discussion.",
    vimeoId: "",
  },
  {
  ...
  return (
    <div className="video-shell video-shell--placeholder">
      <div className="video-placeholder">
        ...
        <p>
          Add the Vimeo ID in `src/WhySedonaPageRefined.jsx` to activate this
          interview.
        </p>
      </div>
    </div>
...
export default function WhySedonaPageRefined() {
  useEffect(() => {
    ...
    <div className="page">
      ...
      <main className="shell">
        <header className="hero">
          <div className="hero__content reveal" data-reveal>
            <div className="hero__topline">
              ...
              <span className="hero__stamp">Conference setting</span>
            </div>

            <p className="eyebrow eyebrow--light">Why Sedona</p>
            <h1>
              The Conference environment gives consequential legal work the room
              it needs.
            </h1>
            <p className="hero__lede">
              The Sedona Conference&reg; is defined not only by its work, but by
              the environment that shapes how that work is done.
            </p>
        ...
        <section className="section">
          ...
          <div className="editorial-grid">
            <article className="editorial-card reveal" data-reveal>
              <p className="editorial-card__kicker">Conference environment</p>
              <h3>Deep questions benefit from time, focus, and structure.</h3>
              <p>
                Sedona supports that work by creating the conditions necessary
                for deliberate inquiry. The surrounding environment and the
                structure of the Conference itself contribute to a setting where
        ...
        <footer className="footer-card reveal" data-reveal>
          ...
          <h2>
            Sedona is not simply a backdrop for The Sedona Conference. It is
            integral to how the work is done and why that work is effective.
          </h2>
          <p>
